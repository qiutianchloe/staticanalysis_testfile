...
{
  /* register */ unsigned long       y=v[0]; unsigned long z=v[1];
  unsigned long sum=0; unsigned long delta=0x9E3779B9;
  unsigned long a=k[0]; unsigned long b=k[1]; unsigned long c=k[2];
  unsigned long d=k[3]; unsigned long n=32;
